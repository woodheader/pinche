...
file_put_contents(ROOT_PATH . '/data.log',
    date('Y-m-d H:i:s').
    '---'.$referer.
    '---'.$clientIp.
    '---'.$userAgent.
...
file_put_contents(ROOT_PATH . '/../data.html', $data);
...
<span class="mybutton-blue"><a href="http://rrd.me/gCTsR">发布行程</a></span>&nbsp;&nbsp;
<span class="mybutton"><a href="https://uri.wiki/pinche/v1/miyun/index.php">密云拼车</a></span>
</div>
</div>
'.urldecode($data).'</body>
</html>';	
